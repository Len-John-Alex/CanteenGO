...
import './VerifyEmail.css'; // Reusing styles
...
const StaffVerify = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await authService.verifyStaffEmail(staffId, verificationCode);
            setSuccess(true);
            setTimeout(() => {
                navigate('/login');
            }, 2000);
    ...
    return (
        <div className="verify-container">
            <div className="verify-card">
                <h1>Staff Email Verification</h1>
                ...
                <div className="verify-footer">
                    ...
                    <p><button className="back-link" onClick={() => navigate('/staff-register')}>Back to Registration</button></p>
                </div>
            </div>
        </div>
    );
